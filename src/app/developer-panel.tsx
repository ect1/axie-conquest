...
export default function DeveloperPanel({
  ...
  return <section className="developer panel" aria-label="Developer">
    ...
    {tab === 'battle' && <fieldset className="battle-debug">
      ...
      <label className="developer-distance">Retreat boundary Z<input type="number" min={-100} max={-1} step={1} value={localEndBattleConfig.retreatAction.retreatBoundaryZ} onChange={event => setLocalEndBattleConfig({ ...localEndBattleConfig, retreatAction: { ...localEndBattleConfig.retreatAction, retreatBoundaryZ: Math.max(-100, Math.min(-1, Number(event.target.value) || -1)) } })} /></label>
